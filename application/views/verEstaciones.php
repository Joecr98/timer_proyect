...
<body>
    ...
    <div class="container mt-5">
        ...
        <!-- Botones de bloqueo y desbloqueo globales con dropdown para seleccionar estación -->
        <div class="d-flex justify-content-center mb-4">
            <button class="btn btn-primary btn-lock">Bloquear estación seleccionada</button>
            <button class="btn btn-success btn-unlock">Desbloquear estación seleccionada</button>
    ...
    <script src="<?= base_url('assets/js/Bloqueo.js') ?>"></script>
</body>
